...
class ResumeParser(object):
    ...
    def __get_basic_details(self):
        ...
        # extract gender
        self.__details['gender'] = utils.extract_gender(self.__text)

        # extract current city
        self.__details['current_city'] = utils.extract_current_city(self.__text)

        # extract resume objective
        self.__details['resume_objective'] = utils.extract_resume_objective(self.__text_raw)
        ...
        try:
            experience_data = utils.extract_experience(self.__resume)
            self.__details['experience'] = experience_data
            try:
                exp = round(
